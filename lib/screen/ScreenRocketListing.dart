...
class _ScreenRocketListingState extends State<ScreenRocketListing> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<CubitRocket, CubitRocketState>(
        builder: (context, state) {
          if (state is CubitRocketLoadingState) {
            ...
            return ListView.builder(
                itemCount: state.listRockets!.length,
                itemBuilder: (context, index) {
                  ModelRocket rocket = state.listRockets![index];
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                              ...
                              children: [
                                Container(
                                    ...
                                    child: widgetText(
                                        ...
                                        fontSize: 16)),
                                widgetTextRow(
                                    Icons.location_on, rocket.country!),
                                Container(
